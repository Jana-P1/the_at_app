...
from myapp.models import User, SuccessStory
...
def user_stories(username):
    ...
    success_stories = SuccessStory.query.filter_by(author=user).order_by(SuccessStory.date.desc()).paginate(page=page, per_page=8)
    return render_template('user_success_stories.html', success_stories=success_stories, user=user) 
